	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (token != null && securityContext.getAuthentication() == null) {
			...
			if (username != null) {
				...
				if (token_gen.isTokenValid(token, utilisateur)) {
					UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(utilisateur,
							null, utilisateur.getAuthorities());
